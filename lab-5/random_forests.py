...
from sklearn.model_selection import train_test_split  # Виправлений імпорт
...
if __name__ == '__main__':
    ...
    X_train, X_test, y_train, y_test = train_test_split(  # Виправлений виклик
